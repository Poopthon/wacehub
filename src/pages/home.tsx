    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className="flex sm:flex-row items-center justify-center gap-2 px-4 text-lg font-medium">
          <a
            className="bg-white p-4 text-gray-700 dark:text-white hover:text-gray-950 flex items-center gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10"
            href="https://github.com/Poopthon/wacehub"
            target="_blank"
            rel="noopener noreferrer"
          >
            GitHub <FaGithub className="text-gray-700 dark:text-white" />
          </a>
